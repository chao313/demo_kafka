 ...
 * 自定义Redis
 */
public abstract class LocalAbstractRedisInstance implements Redis {
    private Logger logger = LoggerFactory.getLogger(LocalAbstractRedisInstance.class);
    ...
    protected LocalAbstractRedisInstance(int port) {
        this.port = port;
    }
    ...
    private void awaitRedisServerReady() throws IOException {
        ...
        try {
            ...
            do {
                ...
                logger.info("自定义redis启动日志:{}", outputLine);
                if (outputLine == null) {
